...
| [M14](M14Bootstrap/README.md) | Bootstrap Basics | Linking via CDN · Bootstrap tour · component classes (button · card · navbar) · utility classes | 2 hrs |
| [M15](M15BootstrapLayoutAndCustomisation/README.md) | Bootstrap Layout & Customisation | 12-col grid · gutters · breakpoints · offset / order / nesting · CSS variables · colour modes | 2 hrs |
...
| **Framework**  | [Bootstrap 5](https://getbootstrap.com/)                       | M14–M15 — component & utility classes, the responsive grid, and CSS-variable theming, all loaded via CDN.                                                                                                                                |
